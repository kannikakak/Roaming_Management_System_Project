...
const pageMetaList: PageMeta[] = [
  ...
  { path: "/ai-studio", title: "AI Ask", subtitle: "Ask questions and view a simple result." },
  { path: "/report-builder", title: "Report Builder", subtitle: "Build report-ready views from uploaded data." },
